...
class COCO2014(data.Dataset):
    def __init__(self, root, transform=None, annonymize=False, phase='train', inp_name=None):
        self.root = root
        self.phase = phase
        self.img_list = []
        self.transform = transform
        self.annonymize = annonymize
    ...
    def get(self, item):
        ...
        if self.annonymize:
            img_path = os.path.join(self.root, 'data', '{}2014_annonymized'.format(self.phase), filename)
